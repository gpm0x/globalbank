            ...
            <Card>
              ...
              <div className="mb-8 grid space-y-3">
                {data.socialProviders.map((provider, index) => (
                  ...
                  >
                    ...
                    />
                    <span>
                      {provider.text || `Entrar com ${provider.name}`}
                    </span>
                  </button>
                ))}
              </div>
              ...
              <div className="mb-8 flex items-center">
                ...
                <span className="px-4 text-gray-400 text-sm">
                  {data.dividerText || 'ou entre com email'}
                </span>
                <div className="flex-1 h-px bg-gray-800"></div>
              </div>
              ...
              <form>
                <fieldset className="border-none p-0 m-0">
                  <legend className="sr-only">Entrar com email e senha</legend>
                  <div className="mb-6">
