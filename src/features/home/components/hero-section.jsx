    ...
    <section className="relative pt-20 lg:pt-28 overflow-hidden">
      <div className="relative z-10 container px-4 mx-auto">
        <div className="relative mb-24 text-center md:max-w-4xl mx-auto">
          ...
          <h1 className="font-heading mb-10 text-5xl md:text-7xl lg:text-8xl xl:text-10xl text-white tracking-tighter">
        ...
        <div className="relative max-w-max mx-auto px-4">
          <img className="w-full h-auto" src="/images/card-half.png" alt="" />
          <img
            className="absolute top-7 -right-10 md:-right-64 w-20 md:w-auto"
            src="/images/star.svg"
            alt=""
          />
        </div>
