    ...
    <section className="py-20 overflow-hidden">
      <div className="container px-4 mx-auto">
        <div className="md:max-w-4xl text-center mx-auto">
          ...
          <h2 className="font-heading mb-12 text-7xl lg:text-8xl text-white tracking-7xl lg:tracking-8xl">Vagas abertas</h2>
          <div className="flex flex-wrap justify-center mb-12">
            {jobCategories.map((category) => (
              <div key={category.id} className="w-auto">
                <a
                  className={`inline-block py-5 px-8 font-medium border-2 rounded-full ${active === category.id ? 'text-green-400 border-green-400' : 'text-gray-300 border-transparent'
                    }`}
                  href="#"
